...
// expected verdict: conditional on target-lowering and helper-timing obligations; unknown without those semantics
// exact incident boundary: source llvm.mul alone establishes no target timing fact
module {

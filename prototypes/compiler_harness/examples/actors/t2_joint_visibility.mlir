...
//   {alice,bob}    SAT / CandidateOnly / accepted Bad_A replay required
...
module attributes {
  ...
  llvm.func @serve_kv_cache(
    ...
    // fixture check: coalition-derived visibility makes only the joint AuditAll
    // row a SAT candidate; values 11/22 must independently replay to Bad_A

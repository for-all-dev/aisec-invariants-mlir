 ...
 *   clang -std=c11 -Wall -Wextra -Wpedantic -I../../../include -c ckks_unsafe_release_fixed.c
 *
 * License note:
...
SPS_ENTRY("ckks_unsafe_release_fixed")
SPS_RETURN_OUTPUT("return")
uint32_t ckks_unsafe_release_fixed(
  ...
  uint32_t sanitized = ckks_sanitize_model(

 ...
 * --target=x86_64-unknown-linux-gnu -S clangover_poly_frommsg_vulnerable.c
 *
 * License note:
...
SPS_ENTRY("clangover_poly_frommsg_x86_bad_model")
__attribute__((noinline)) void
clangover_poly_frommsg_vulnerable(int16_t out[256] SPS_ROOT("out"),

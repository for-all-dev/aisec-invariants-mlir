...
// CHECK: %[[MASK:[0-9]+]] = llvm.sub %[[ZERO]], %[[BIT]] {sps.fixture_refs = ["snapshot.public[0]", "snapshot.public[1]"], sps.observable_candidate = ["control", "timing"]}
// CHECK-NOT: llvm.cond_br
...
// CHECK-SAME: %[[WRAPPER_BIT:[a-zA-Z0-9_]+]]: i16 {sps.fixture_refs = ["snapshot.secret[0]"], sps.label = "high"}
// CHECK-NOT: llvm.cond_br

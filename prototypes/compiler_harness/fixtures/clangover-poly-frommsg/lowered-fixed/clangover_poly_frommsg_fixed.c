 ...
 *   clang -I../../../include -Os -fno-vectorize -fno-slp-vectorize
 * --target=x86_64-unknown-linux-gnu -S clangover_poly_frommsg_fixed.c
 *
 * License note:
...
extern int16_t clangover_ct_cmov(int16_t if_zero, int16_t if_one, uint16_t bit);

SPS_ENTRY("clangover_poly_frommsg_fixed")
__attribute__((noinline)) void
clangover_poly_frommsg_fixed(int16_t out[256] SPS_ROOT("out"),
                             const uint8_t msg[32] SPS_ROOT("msg")) {

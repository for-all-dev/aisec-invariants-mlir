/*
 * Case: synthetic KyberSlash1 / poly_tomsg target-control oracle
 *
 ...
 *   Keeps the vulnerable poly_tomsg arithmetic, but adds a semantically
 ...
 *   clang -I../../../include -O0 -S -emit-llvm kyberslash1_poly_tomsg_target_bad.c
 *
 * License note:
...
SPS_ENTRY("kyberslash1_poly_tomsg_target_bad")
SPS_RETURN_OUTPUT("return")
__attribute__((noinline)) uint8_t kyberslash1_poly_tomsg_target_bad(

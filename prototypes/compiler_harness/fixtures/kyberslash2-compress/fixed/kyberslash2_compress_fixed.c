 ...
 *   clang -I../../../include -O0 -Xclang -disable-O0-optnone --target=aarch64-unknown-linux-gnu -S
 * -emit-llvm kyberslash2_compress_fixed.c
 *
 * License note:
...
SPS_ENTRY("kyberslash2_compress_fixed")
SPS_RETURN_OUTPUT("return")
__attribute__((noinline)) uint8_t
kyberslash2_compress_fixed(uint16_t coefficient SPS_COMPONENT("coefficient")) {

 ...
 *     x86 backend then converts the select to a branch exactly as it does there:
 *         testl %edi, %edi
 *         je    .LBB0_2
 *
 *   So the author wrote branchless code, the compiler recognized the intent,
 *   converted it to the very construct the author was avoiding, and a later pass
 *   turned that into the branch the author was avoiding.
 *
 ...
 *   clang -O2 --target=x86_64-unknown-linux-gnu -S launder_scan_folded_bad.c
 *
 * License note:

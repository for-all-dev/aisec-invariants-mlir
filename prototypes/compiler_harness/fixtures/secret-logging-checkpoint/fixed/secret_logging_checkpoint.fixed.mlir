...
// CHECK-NOT: llvm.store {{.*}}, %[[LOG]]
// CHECK-NOT: llvm.store {{.*}}, %[[CHECKPOINT]]
// CHECK: llvm.store %[[ZERO]], %[[LOG]] {sps.fixture_refs = ["snapshot.public[0]"], sps.sink_class = "public"}
// CHECK-NOT: llvm.store {{.*}}, %[[LOG]]
// CHECK-NOT: llvm.store {{.*}}, %[[CHECKPOINT]]
// CHECK: llvm.store %[[ZERO]], %[[CHECKPOINT]] {sps.fixture_refs = ["snapshot.public[1]"], sps.sink_class = "public"}
// CHECK-NOT: llvm.store {{.*}}, %[[LOG]]
// CHECK-NOT: llvm.store {{.*}}, %[[CHECKPOINT]]
// CHECK: llvm.return
module {

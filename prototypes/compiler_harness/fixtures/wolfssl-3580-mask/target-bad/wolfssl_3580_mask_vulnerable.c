 ...
 *   riscv32-gcc -I../../../include -O3 -march=rv32i -mabi=ilp32 -S wolfssl_3580_mask_vulnerable.c
 *
 * License note:
...
SPS_ENTRY("wolfssl_3580_rv32_bad_model")
SPS_RETURN_OUTPUT("return")
__attribute__((noinline)) uint32_t wolfssl_3580_mask_vulnerable(
    const uint32_t table[16] SPS_ROOT("table"),

...
//
// case: metatheory/MT-CM2-symmetric-bound-exhaustion
// entry: bound_exhausted_public_loop
...
// secret: none reaches loop control
// public: %public_count, the start value 0, the increment 1, and the sink target
// diagnostic focus: world-structural-control-trace
// evidence boundary: with the L0 public bound set below public_count, both
// L2 lanes reach the same modeled BoundExhausted transition; bound adequacy stays

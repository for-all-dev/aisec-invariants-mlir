...
//
// case: release/carrier-pinned-control
// entry: release_carrier_pinned_control
...
// diagnostic focus: release-carrier-pinned
// evidence boundary: L1 only. No ModelStatus claim.
//
// PAIRED CONTROL for release_carrier_lost.bad.mlir and
// release_carrier_marker_only.bad.mlir.
//

...
// entry: secret_embedding_index_bad
...
// CHECK-SAME: %[[TABLE:[a-zA-Z0-9_]+]]: !llvm.ptr, %[[SECRET:[a-zA-Z0-9_]+]]: i32 {sps.label = "high"}
...
module {
  llvm.func @secret_embedding_index_bad(
      %table: !llvm.ptr, %secret_index: i32 {sps.label = "high"}) -> i32 {
